...
git clone https://github.com/gustavoadolfo/minhoteca-adapter-layer.git
cd minhoteca-adapter-layer
git remote add upstream https://github.com/gustavoadolfo/minhoteca-adapter-layer.git
```
